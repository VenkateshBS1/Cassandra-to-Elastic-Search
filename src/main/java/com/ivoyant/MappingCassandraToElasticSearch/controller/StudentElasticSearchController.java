...
public class StudentElasticSearchController {
    ...
    @Autowired
    private ElasticStudentService elasticStudentService;
    ...
    public ResponseEntity<String> createStudent(@RequestBody ElasticStudent elasticStudent) throws IOException {
        studentElasticSearchRepository.save(elasticStudent);
